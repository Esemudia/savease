<%@ Page Title="" Language="C#" MasterPageFile="~/saveaze_no_cfooter.Master" AutoEventWireup="true" CodeBehind="pin.aspx.cs" Inherits="saveasze.pin" %>
...
<EnabledStyle Resize="None"></EnabledStyle>
      ...
      <telerik:RadGrid RenderMode="Lightweight" ID="gridBatch" runat="server" 
        AllowPaging="True" PageSize="20" AllowSorting="True" font-family="Arial,Helvetica,sans-serif"
          Font-Size="12px" Skin="WebBlue"  OnNeedDataSource="gridBatch_NeedDataSource">
    ...
    <Columns>
        ...
        <asp:TemplateField HeaderText="Order Date" ItemStyle-Width = "200">
            <ItemTemplate>
                <asp:Label ID = "lblOrderDate" runat="server" Text='<%# Eval("oderDate") %>'></asp:Label>
                           ...
                           <asp:Button ID="btnUpdate" runat="server" Text="Block Pin" class="thm-btn" OnClick = "BlockPin_Click" Visible = "false"/>
                            <%-- Block Pin Section below --%>
                                      <table class="tbl-btn">
                                           <tr><td runat="server" id="Td1" style="font-size: 12px;color:black;">Export By:</td><td>
                                          <telerik:RadDropDownList ID="drpPrintOption1" runat="server" SelectedText="Select Criteria"  CssClass="ddl"  AutoPostBack="false">
                                              <Items>
                                                  <telerik:DropDownListItem CssClass="drop" runat="server" Text="Select Criteria"  Value="0"/>
                                                  <telerik:DropDownListItem CssClass="drop" runat="server" Text="Current Page"  Value="1"/>
                                                  <telerik:DropDownListItem CssClass="drop" runat="server" Text="All Pages" Value="2" />
                                                   </Items>
                                          </telerik:RadDropDownList></td><td>&nbsp:</td>
                                           <td class="jj"  style="text-align:center;">
                                                <asp:Button CssClass="thm-btn" Text="Convert to Word to Print" runat="server" ID="btnprint1" OnClick = "btnprint1_Click" Height="40px" />
                <asp:Button CssClass="thm-btn-tr" Text="Convert to Excel" runat="server" ID="btnprint3" OnClick = "btnprint3_Click" Height="40px"/>
                ...
                </asp:DropDownList>--%><asp:Button runat="server" ID="btnprint2" Text="Print" Visible="false" />
               <%-- <asp:ImageButton runat="server" ID="btnprint" Text="Print" OnClick = "btnprint_Click" ImageUrl="~/images/Excel_XLSX.png"  />
               --%><br />   
