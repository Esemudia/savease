<%@ Page Title="" Language="C#" MasterPageFile="~/saveaze_no_cfooter.Master" AutoEventWireup="true" CodeBehind="Readmail.aspx.cs" Inherits="saveasze.Readmail" %>
               ...
               <ul class="nav nav-pills nav-stacked">
                <li><a href="MailBox.aspx"><i class="fa fa-inbox"></i> Inbox
                 ...
                 <li><a href="unread.aspx"><i class="fa fa-envelope-o"></i> Unread
                  ...
                  <li class="active"><a href="Readmail.aspx"><i class="fa fa-envelope-open"></i> Read
          ...
          <div class="box box-primary">
            ...
            <div class="box-body no-padding">
              <div class="mailbox-controls">
                ...
                <!-- /.btn-group -->
                <button type="button" class="btn btn-default btn-sm" title="Refresh"><i class="fa fa-refresh"></i></button>
              ...
              <div class="table-responsive mailbox-messages">
                ...
                <ItemTemplate>
                    <tr align="left">                            
                                ...
                                <td style="width:40px" >
                              <a href="compose.aspx?i00=<%# Eval("notID") %>&i01=<%# Eval("recerverID") %>"><%#Eval("saveaseID") %></a></td>
                                <td style="width:100px"><a href="compose.aspx?i00=<%# Eval("notID") %>&i01=<%# Eval("recerverID") %>"><%#Eval("senderName") %></a></td>
