 <%@ Page Title="" Language="C#" MasterPageFile="~/saveaze_no_cfooter.Master" AutoEventWireup="true" CodeBehind="MailBox.aspx.cs" Inherits="saveasze.MailBox" %>
              ...
              <div class="table-responsive mailbox-messages">
                ...
                <HeaderTemplate>
                    <table class="table table-hover table-striped">
                        <tr align="left" style="font-weight:bolder;">
                            ...
                            <td style="text-align:left"><asp:Label ID="Label1" Text="Sender ID" runat="server" Width="70px"></asp:Label></td>
                            <td style="text-align:left"><asp:Label ID="lblName" Text="Sender Name" runat="server" Width="100px"></asp:Label> </td>
                            <td>Subject</td>
                            <td>Date</td>
                        </tr>
                </HeaderTemplate>
                <ItemTemplate>  
                    <tr align="left">                            
                                ...
                                <td style="width:40px" >
                                   <asp:linkbutton id="lnkSaveaseID" runat="server" onclick="onclick_pwd" xmlns:asp="#unknown"><%#Eval("saveaseID") %></asp:linkbutton> 
                                     <asp:Label ID="lblSaveaseID" runat="server" Text='<%# Eval("saveaseID") %>' Visible="false" /> 
                                    <asp:Label ID="lblsenderName" runat="server" Text='<%# Eval("senderName") %>' Visible="false" />
                                    <asp:Label ID="lblsubject" runat="server" Text='<%# Eval("subject") %>' Visible="false" />
                                    <asp:Label ID="lblsendDate" runat="server" Text='<%# Eval("sendDate") %>' Visible="false" />

                                    <asp:Label ID="lblNotID" runat="server" Text='<%# Eval("notID") %>' Visible="false" />
                                    <asp:Label ID="lblrecerverID" runat="server" Text='<%# Eval("recerverID") %>' Visible="false" />
                                    <asp:Label ID="lblorderNumber" runat="server" Text='<%# Eval("orderNumber") %>' Visible="false" />
                                </td>
                                <td>
                                   <asp:linkbutton id="Linkbutton1" runat="server" onclick="onclick_pwd" xmlns:asp="#unknown"><%#Eval("senderName") %></asp:linkbutton> 
                                </td>
                                <td>
                                   <asp:linkbutton id="lnksubject" runat="server" onclick="onclick_pwd" xmlns:asp="#unknown"><%#Eval("subject") %></asp:linkbutton> 
                                </td>
                                <td>
                                   <asp:linkbutton id="lnksendDate" runat="server" onclick="onclick_pwd" xmlns:asp="#unknown"><%#Eval("sendDate") %></asp:linkbutton> 
                                </td>
                        </tr>
                </ItemTemplate>
                <FooterTemplate>
