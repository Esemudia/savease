<%@ Page Title="" Language="C#" MasterPageFile="~/saveaze_no_cfooter.Master" AutoEventWireup="true" CodeBehind="transactionsOrder.aspx.cs" Inherits="saveasze.transactionsOrder" %>
...
<section class="service-single sec-padd">
    <div class="container">
            ...
            <div class="col-md-9"> 
                <div class="outer-box"><br><br>
                    <div class="section-title">
                        <h3>Transaction Logs(My Orders) </h3>
                    </div>
                    <div class="row">
                        <div class="col-md-5 col-sm-5 col-xs-12"><br><br>
                  
                            <telerik:RadDropDownList ID="cmdAcctType"  CssClass="ddl" runat="server" SelectedText="Order Details" SelectedValue="1" AutoPostBack="True" OnSelectedIndexChanged="cmdAcctType_SelectedIndexChanged"  Width="200px">
                                                        <Items>
                                                            <telerik:DropDownListItem CssClass="drop" runat="server"  Value="0" Text="Withdrawal"  />
                                                            <telerik:DropDownListItem CssClass="drop" runat="server" Selected="True" Text="Order Details" Value="1" />
                                                            <telerik:DropDownListItem CssClass="drop" runat="server" Text="My Deposit" Value="2" />
       ...
       <%-- <telerik:RadSearchBox RenderMode="Lightweight" runat="server" ID="RadSearchBox1" Width="150"
                MaxResultCount="10" EmptyMessage="Filter Result"
                DataTextField="acctName" DataValueField="acctName">
                <DropDownSettings Height="400" Width="300">
                </DropDownSettings>
            </telerik:RadSearchBox>--%><br /><br />
        </div>
