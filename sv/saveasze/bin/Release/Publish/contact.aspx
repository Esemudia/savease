<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="contact.aspx.cs" Inherits="saveasze.contact" %>
...
<body>
    ...
    <section class="container-fluid mt-md-5 form-section">
        <div class="row justify-content-center">
            <h5 class="col-12 section-heading text-center">Contact us</h5>
            <div class="col-lg-7 col-md-7 col-12 pt-3 pb-3 mt-4">
                <div class="row justify-content-center align-items-center">
                    <form action="#" runat="server" id="form1" class="col-12 col-sm-12 col-md-10">
                        <div class="row justify-content-center">
                            <div class="form-group col-md-6 col-10 mb-4">
                                <input type="text" runat="server" id="txtname" placeholder="Full Name" required>
                            </div>
                            <div class="form-group col-md-6 col-10 mb-4">
                                <input type="email" runat="server" id="txtfrom" placeholder="Email Address" required>
                            </div>
                            <div class="form-group col-md-6 col-10 mb-4">
                            ...
                            <div class="form-group col-md-12 col-10 mb-4">
                                <textarea rows="4" runat="server" id="txtbody" placeholder="Message Here" required></textarea>
                            </div>
                            <div class="form-group col-10 mt-3">
                                <div class="row justify-content-center">
                                    <asp:Button runat="server" Text="Send Message" CssClass="btn col-6 orange-bg p-2" ID="btnsend" OnClick="btnsend_Click" />
                                </div>
                            </div>
                        </div>
                    </form>
            ...
            <div class="col-lg-5 col-md-5 col-12 pt-3 pb-3">
                <div class="row justify-content-center align-items-center">
                    <div class="col-12 mb-2">
                        <div class="col-12 grey-bg pt-3 pb-1">
                            <h5 class="col-12">Head Office:</h5>
                            <ul class="col-12">
                                <li class="row">
                                    <span class="col-2">Street: </span>
                                    <p class="col-10">1C, Evo Crescent, GRA II.</p>
                                </li>
                                <li class="row">
                                    <span class="col-2">City: </span>
                                    <p class="col-10">Port Harcourt.</p>
                                </li>
                                <li class="row">
                                    <span class="col-2">State:</span>
                                    <p class="col-10">Rivers State.</p>
                                </li>
                            </ul>
                        </div>
                    </div>
                        ...
                        <div class="col-12 grey-bg pt-3 pb-1">
                            ...
                            <ul class="col-12">
                                <li class="row">
                                    ...
                                    <p class="col-10">info@savease.ng</p>
                                </li>
                                <li class="row">
