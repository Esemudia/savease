...
namespace saveasze
{
    public partial class pin : System.Web.UI.Page
    {
        ...
        protected void btnprint3_Click(object sender, EventArgs e)
        {
            ...
            gridBatch.Columns.ToString();
            gridBatch.ExportSettings.Excel.Format = (GridExcelExportFormat)Enum.Parse(typeof(GridExcelExportFormat), "Xlsx");
            gridBatch.ExportSettings.IgnorePaging = (drpPrintOption1.SelectedIndex == 1) ? false : true;
            gridBatch.ExportSettings.ExportOnlyData = false;
            gridBatch.ExportSettings.OpenInNewWindow = true;
            //     gridBatch.MasterTableView.GetColumn("VoucherPin").DataType.UnderlyingSystemType.st;//.HeaderStyle.BackColor
            //    gridBatch.MasterTableView.GetColumn("BatchNo").DataType.ToString();//.HeaderStyle.BackColor
            //  gridBatch.MasterTableView.GetColumn("SerialNumber").DataType.ToString();//.HeaderStyle.BackColor
            //gridBatch.Width = Unit.Percentage(100);
           // gridBatch.MasterTableView.ExportToWord();
            gridBatch.MasterTableView.ExportToExcel();
        }
        ...
        protected void btnprint_Click(object sender, EventArgs e)
        {
            ...
            #region [ XSLX FORMAT ]
            #endregion
            gridBatch.ExportSettings.Excel.Format = (GridExcelExportFormat)Enum.Parse(typeof(GridExcelExportFormat), "Print");
            gridBatch.ExportSettings.IgnorePaging = (drpPrintOption.SelectedIndex==0)?false:true;
            gridBatch.ExportSettings.ExportOnlyData = true;
            gridBatch.ExportSettings.OpenInNewWindow = true;
            gridBatch.MasterTableView.ExportToExcel();
        }
*/
