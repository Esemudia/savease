<%@ Page Title="" Language="C#" MasterPageFile="~/admin/adm.Master" AutoEventWireup="true" CodeBehind="board.aspx.cs" Inherits="saveasze.admin.board" %>
<%@ Register assembly="Telerik.Web.UI" namespace="Telerik.Web.UI" tagprefix="telerik" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server" style="width:800px;margin-left:auto;margin-right:auto;">
    <br />
    
   
      <div class="container">
					<div class="side-app" style="width:990px;margin-left:auto;margin-right:auto;">
								...
								<div class="card overflow-hidden">
									...
									<div class="card-body row">
										<div class="col">
											...
											<div class="h3 m-0 text-primary counter font-30"><b runat="server" id="bcountusers"></b></div>
										</div>
							...
							<div class="col-sm-12 col-md-6 col-lg-3">
								<div class="card overflow-hidden">
									...
									<div class="card-body">
										<div class="row">
											<div class="col">
												<div class="text-muted">Total Cards Generated</div>
												<div class="h3 m-0  text-teal counter font-30"><b runat="server" id="bcountgen"></b></div>
											</div>
											<div class="col-auto align-self-center">
												<div class="card-value float-right text-purple">
									...
									<div class="card-body ">
										<div class="row">
											<div class="col">
												...
												<div class="h3 m-0 text-orange counter font-30"><b runat="server" id="bcountVendors"></b></div>
											</div>
											<div class="col-auto align-self-center">
												<div class="card-value float-right text-purple">
									...
									<div class="card-body">
										<div class="row">
											<div class="col">
												...
												<div class="h3 m-0  text-blue counter font-30"><b runat="server" id="bIncome"></b></div>
											</div>
											<div class="col-auto align-self-center">
							...
							<div class="col-sm-6 col-lg-3">
								<div class="card p-3">
									<div class="d-flex align-items-center">
										...
										<div>
											<h4 class="m-0"><a href="javascript:void(0)"><strong><b runat="server" id="bven"></b></strong> <small>Online Vendors</small></a></h4>
							...
							<div class="col-sm-6 col-lg-3">
								<div class="card p-3">
									<div class="d-flex align-items-center">
										...
										<div>
											<h4 class="m-0"><a href="javascript:void(0)"><strong><b runat="server" id="tusr"></b></strong> <small>online Customer</small></a></h4>
							...
							<div class="col-sm-6 col-lg-3">
								<div class="card p-3">
									<div class="d-flex align-items-center">
										...
										<div>
											<h4 class="m-0">
                                                <a href="javascript:void(0)"><strong runat="server" id="lblonline"></strong>&nbsp;<small> Total Online Users</small></a></h4>
										</div>
									</div>
